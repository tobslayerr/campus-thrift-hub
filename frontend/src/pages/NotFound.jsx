    ...
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 text-center animate-in fade-in zoom-in duration-500">
            ...
            <p className="text-slate-500 font-medium max-w-md mx-auto mb-10 leading-relaxed text-sm md:text-base">
                Halaman atau barang yang kamu cari mungkin salah URL, sudah <b>dihapus permanen</b>, atau pemiliknya terkena <b>sanksi (Banned)</b> karena melanggar aturan komunitas Campus Thrift Hub.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button 
                    onClick={() => navigate(-1)}
                    className="flex items-center justify-center gap-2 px-8 py-4 bg-slate-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-800 transition-all shadow-xl active:scale-95"
                >
                    <ArrowLeft size={18} /> Kembali
                </button>
                <Link 
                    to="/explore"
                    className="flex items-center justify-center gap-2 px-8 py-4 bg-[#FF9500] text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-[#e68600] transition-all shadow-xl active:scale-95 shadow-orange-900/10"
                >
                    <Search size={18} /> Cari Barang Lain
                </Link>
                <Link 
                    to="/"
                    className="flex items-center justify-center gap-2 px-8 py-4 bg-white border-2 border-slate-100 text-slate-400 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-50 transition-all active:scale-95"
                >
